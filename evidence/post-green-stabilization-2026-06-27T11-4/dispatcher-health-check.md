...
**Date/Time:** 2026-06-27T11:41:24.928Z
**Health Status:** `HEALTH_YELLOW`
**Session:** post-green-stabilization-2026-06-27T11-4
...
### ⚠️ git-status
- **Status:** WARN
- **Detail:** Branch: master, Commit: 020018e, Green: false
- **Duration:** 0ms
- **Evidence:** `{"branch":"master","commit":"020018e39195ebb3f89cab5302a056396254f62e","commitMessage":"docs(n8n): freeze dispatcher green baseline","isGreenCommit":false}`

### ✅ evidence-dirs
- **Status:** PASS
- **Detail:** 11 evidence directories found
- **Duration:** 0ms
- **Evidence:** `{"count":11,"latest":"playwright-mcp-green-baseline-check-20260627T1131Z"}`
